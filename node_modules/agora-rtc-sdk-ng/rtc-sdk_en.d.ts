 ...
 *
 * Callback for changes in the [Audio Context](https://developer.mozilla.org/en-US/docs/Web/API/AudioContext) state.
 *
...
export declare interface IAgoraRTC extends EventEmitter {
     ...
     * > Note:
     * > - This function is supported on Chrome 74 or later on Windows, macOS, and ChromeOS platforms.
     * > - On Windows and ChromeOS, this function allows you to share the audio when sharing the entire screen and sharing Chrome tabs, but not when sharing the application window.
