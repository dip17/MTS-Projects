 ...
 *
 * 音频上下文 ([Audio Context](https://developer.mozilla.org/en-US/docs/Web/API/AudioContext)) 状态发生改变回调。
 *
...
export declare interface IAgoraRTC extends EventEmitter {
     ...
     * > 注意事项：
     * > - 该功能支持 Windows、macOS、ChromeOS 平台下的 Chrome 浏览器 74 及以上版本。
     * > - Windows 和 ChromeOS 平台支持在共享整个屏幕和共享 Chrome 标签页时分享音频，不支持在共享应用窗口时分享音频。macOS 平台仅支持在共享 Chrome 标签页时分享音频。
